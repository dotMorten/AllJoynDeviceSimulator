...
// Methods
// Readable Properties
DismisserGetVersionRequestedEventArgs::DismisserGetVersionRequestedEventArgs(
    _In_ AllJoynMessageInfo^ info)
    : m_raised(false),
    m_completionsRequired(0),
    m_messageInfo(info)
{
	m_result = DismisserGetVersionResult::CreateFailureResult(ER_NOT_IMPLEMENTED);
}

Deferral^ DismisserGetVersionRequestedEventArgs::GetDeferral()
{
    ...
    auto handler = ref new DeferralCompletedHandler(this, &DismisserGetVersionRequestedEventArgs::Complete);
    return ref new Deferral(handler);
}

void DismisserGetVersionRequestedEventArgs::InvokeAllFinished()
{
    bool invokeNeeded;
...
void DismisserGetVersionRequestedEventArgs::Complete()
{
    bool invokeNeeded;
...
void DismisserGetVersionRequestedEventArgs::InvokeCompleteHandler()
{
