...
// Methods
// Property Reads
IAsyncOperation<DismisserGetVersionResult^>^ DismisserServiceEventAdapter::GetVersionAsync(_In_ AllJoynMessageInfo^ info)
{
    auto args = ref new DismisserGetVersionRequestedEventArgs(info);
    GetVersionRequested(this, args);
    return DismisserGetVersionRequestedEventArgs::GetResultAsync(args);
}
