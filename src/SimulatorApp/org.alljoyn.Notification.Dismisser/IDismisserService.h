...
public interface class IDismisserService
{
public:
    ...
    Windows::Foundation::IAsyncOperation<DismisserGetVersionResult^>^ GetVersionAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info);
